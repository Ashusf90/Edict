...
**Agent onboarding**: The agent receives the AST schema (TypeScript interfaces) and 33 example programs as part of its system prompt or MCP resource. No documentation needed — the schema *is* the spec.
