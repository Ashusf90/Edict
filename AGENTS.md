...
| Examples | [`examples/`](examples/) | 37 example programs — see [`README`](examples/README.md) for difficulty tiers |
...
tests/             # 1713 tests across 100 files
examples/          # 37 example programs (⭐→⭐⭐⭐ difficulty in README)
