...
| Examples | [`examples/`](examples/) | 34 example programs — see [`README`](examples/README.md) for difficulty tiers |
...
tests/             # 1697 tests across 100 files
examples/          # 34 example programs (⭐→⭐⭐⭐ difficulty in README)
